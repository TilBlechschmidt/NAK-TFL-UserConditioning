...
public var SurveyTask: ORKOrderedTask {
    ...
    let rawAssignments = [
        Assignment(task: "Wie lange geht der Gratis-Zeitraum des Heise+ Zeitschriften-Abo?", help: "Besuche die Website der IT-Zeitschrift Heise. Es wird dort für ein Premium-Abo namens 'heise+' mit einem Gratis-Zeitraum für Neukunden geworben. Finde heraus wie lange dieser Zeitraum geht", solutionLabel: "Zeitraum in Wochen"),
        Assignment(task: "Wie viel kostet die UCI Unlimited Card im Monat?", help: "Die UCI Kinowelt bietet eine Kino-Flatrate namens 'Unlimited' an. Besuche ihre Website über die Lesezeichen und schaue ob du die Seite zur Flatrate ausfindig machen kannst. Dort steht auch der monatliche Preis.", solutionLabel: "Preis in €"),
        ...
        Assignment(task: "Wie heißt der Filialleiter von deinem nächstgelegenen famila?", help: "Suche über die famila Website (in den Lesezeichen zu finden) die Filiale, welche in deiner Nähe ist. Dort ist auch der Name des Warenhausleiter angegeben.", solutionLabel: "Vorname des Warenhausleiter"),
        Assignment(task: "Wie hoch ist der vorausgesetzter Gehaltseingang damit das ING-DiBa Girokonto kostenlos ist?", help: "Du findest die ING-DiBa Bank in den Lesezeichen. Diese bietet ein Girokonto an, welches unter bestimmten Konditionen kostenlos ist. Finde den minimalen Geldbetrag, der monatlich auf deinem Konto eingehen muss, damit dieses kostenfrei bleibt.", solutionLabel: "Betrag in €")
    ]
    
    let assignments = rawAssignments.enumerated().shuffled().enumerated()
    
    let fakeAssignment = Assignment(task: "Finde den Grundpreis der 'Graduation Dinky Duck' 🦆", help: "Öffne den Dcuk Shop über die Lesezeichen. Dort findest du eine Menge süßer Enten. Schaue ob du den Preis für die Dinky Duck als Abschlussgeschenk (Graduation auf Englisch) findest! Es gibt eine Suche und Kategorien.", solutionLabel: "Preis in £")
